      ...
      <section className="px-6 py-8 md:px-12 lg:px-24">
        <div className="max-w-7xl mx-auto">
          ...
          {!isLoading && !error && filteredProfiles.length > 0 && (
            ...
            duration: 0.5,
            delay: index * 0.1
          }} className="bg-white border-2 border-gray-200 p-6 hover:border-black transition-all duration-300 group">
                  {/* Profile Header */}
                  ...
                  <div className="mb-6">
                    <div className="flex flex-wrap gap-2">
                      {profile.interests.map(interest => <span key={interest} className="px-2 py-1 bg-gray-100 text-gray-700 text-xs font-medium border border-gray-200">
                          {interest}
                        </span>)}
                    </div>
                  </div>
